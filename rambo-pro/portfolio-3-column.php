...
<div class="container">	
	...
	<?php 	global $paged;
			...
			$args = array('post_type' => 'rambopro_project','posts_per_page' => 6,'paged' =>$paged );
			global $portfolio;
				...
				<div class="span4 portfolio_column">		
					<div  class="portfolio_showcase">
						<div class="portfolio_showcase_media">				
							<?php the_post_thumbnail('portfolio-3c-thumb'); ?>							
		...
		<?php } else { 
			...
			<div class="span4 portfolio_column">
				<div  class="portfolio_showcase">
					<div class="portfolio_showcase_media">
						<img src="<?php echo WEBRITI_TEMPLATE_DIR_URI; ?>/images/default/port/port_three<?php echo $i; ?>.png" alt="Rambo" class="portfolio_showcase_img">
						<div class="portfolio_showcase_overlay">
							<div class="portfolio_showcase_overlay_inner">
								<h2><a href="#" title="Rambo"><?php _e('Responsive Portfolio by Scientech','rambo'); ?></a></h2>
								<div class="portfolio_showcase_icons">
									<a href="#" title="Rambo"><i class="fa fa-link"></i></a>
									<a class="hover_thumb" rel="lightbox[group]" href="<?php echo WEBRITI_TEMPLATE_DIR_URI; ?>/images/default/port/port_three<?php echo $i; ?>.png"><i class="fa fa-eye"></i></a>
								</div>
							</div>
						</div>
					</div>
