			...
			<tr>
    			...
    			<td>
					<select class="select-medium" size="1" id="dropcp_style" name="dropcp_style">
						<option value="dropcap_square_content" selected="selected">Sqaure Content</option>
						<option value="dropcap_circle_bg_content">Sqaure Circle</option>
						<option value="dropcap_simple_content">Simple/Default</option>
					</select>
				</td>
    		</tr>
			<tr>
