...
<form action="/" method="get" accept-charset="utf-8">
       	<table class="table table-bordered table-condensed">
			<tbody>
			    ...
			    <tr>
				   <td class="lable-all" >Select Style</td>
                    <td class="lable-all"> 
					    <select name="tabs-style" id="tabs-style" size="1">
			...
			<tr>
				...
				<tr>
					<td>&nbsp;</td>
		<td><a href="javascript:TabsDialog.insert(TabsDialog.local_ed)" id="insert" style="display: block; line-height: 24px;">Insert</a></td>
				</tr>
			</tbody>
		</table>
