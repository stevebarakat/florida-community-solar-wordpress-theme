    		...
    		<tr>
    			...
    			<td>
					<select class="select-medium" size="1" id="buttonstyle" name="buttonstyle">
                      	<option selected="selected" value="button_blue">Blue</option>
						<option value="button_green">Green</option>
						<option value="button_white">White</option>
					    <option value="button_skyblue">Black</option>
						<option value="button_red">Red</option>
						<option value="button_orange">Orange</option>
                        <option value="button_grey">Grey</option>
					</select>
				</td>
    		</tr>
			<tr>
    			...
    			<td>
					<select class="select-medium" size="1" id="size" name="size">
            			...
            			<option selected="selected" value="button_large">Large</option>
						<option value="button_small">Small</option>
            			<option value="button_mini">Mini</option>
        			</select>				
				</td>
    		</tr>
			<tr>
