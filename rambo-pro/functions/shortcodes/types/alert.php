    ...
    <table class="table table-bordered table-condensed">
			...
			<tr>
    		   <td class="lable-all"> Close Button Color</td>
    			<td>
					<select class="select-medium" size="1" id="alert_color" name="alert_color">
    			...
    			<td>
					<select class="select-medium" size="1" id="alert_style" name="alert_style">
						<option value="shortcode_alert_error" selected="selected">Type1</option>
						<option value="alert1">Type2</option>
						<option value="alert_success">Type3</option>
