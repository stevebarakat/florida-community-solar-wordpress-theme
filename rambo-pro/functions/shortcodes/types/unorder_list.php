...
<form action="/" method="get" accept-charset="utf-8">
       	<table class="table table-bordered table-condensed">
			...
			<tr>
		   <td class="lable-all" >New List Group?<br/ ><small>Select yes if you want to select new list st</small></td>
                    <td class="lable-all"> 
				...
				<tr>
					<td class="lable-all">List Content</td>
				...
				<tr>
					<td>&nbsp;</td>
		<td><a href="javascript:ListuDialog.insert(ListuDialog.local_ed)" id="insert" style="display: block; line-height: 24px;">Insert</a></td>
				</tr>
			</tbody>
		</table>
