...
<p><?php _e("You must be",'rambo')?> <a href="<?php echo get_option('siteurl'); ?>/wp-login.php?redirect_to=<?php echo urlencode(get_permalink()); ?>"><?php _e("logged in",'rambo')?></a> <?php _e("to post a comment",'rambo')?>
</p>
<?php else : ?>
