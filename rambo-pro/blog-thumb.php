<?php // Template Name: Blog thumb feature image ?>
				...
				<div class="media">
					...
					<p><?php if($posttags) { ?>
						<span class="blog_tags">
							...
							<a href="<?php the_permalink(); ?>"><?php the_tags('<b>Tags:</b>');?></a>
						</span>	<?php } ?>					
						<a class="blog_section_readmore pull-right" href="<?php the_permalink(); ?>"><?php _e('Read more...','rambo'); ?></a>
					</p>
					</div>
				</div>
			</div>
